...
public function print_job($id)
{
  ...
  $view_data['reports_data']=$this->db->query("SELECT jobs.*,spares.*,assets.code as reg,assets.description as make,employees.name as employee,
    jobs.description as description,assets.km_reading as km_reading,assets.next_time_km,assets.next_time_miles,jobs.created_at as created,parts_suppliers.name as supplier FROM jobs
