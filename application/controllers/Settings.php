...
class Settings extends Pre_loader {
    ...
    function save_general_settings() {
        $settings = array("site_logo", "invoice_logo", "show_background_image_in_signin_page", "show_logo_in_signin_page", "app_title", "language", "timezone", "date_format", "time_format", "first_day_of_week", "default_currency", "currency_symbol", "decimal_separator", "accepted_file_formats", "rows_per_page", "item_purchase_code", "scrollbar", "product_serial", "serial_prefix", "order_project_tasks", "add_projects_from_excel");
    ...
    function save_company_settings() {
        $settings = array("company_name", "company_address", "company_phone", "company_email", "company_website", 'working_hours', 'opening_hours', 'admin_costs');
    ...
    function save_invoice_settings() {
        $settings = array("allow_partial_invoice_payment_from_clients", "invoice_color", "invoice_footer", "send_bcc_to");
    ...
    function save_module_settings() {
        ...
        $settings = array("module_timeline", "module_event", "module_note", "module_message", "module_invoice", "module_expense", "module_attendance", "module_leave", "module_estimate", "module_estimate_request", "module_ticket", "module_announcement", "module_sage");
