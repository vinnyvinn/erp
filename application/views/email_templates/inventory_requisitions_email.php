...
<p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px"> Your Inventory Requisite for <?= $item_name . " (" . $item_quantity . ") " ;?>, requested on <?= $request_date;?> has been <?= $status; ?></p>
