...
<div class="modal-body clearfix">
    ...
    <div class="tab-content mt15">
        ...
        <div role="tabpanel" class="tab-pane" id="job-info-tab">
            ...
            <div class="form-group">
                <label for="salary" class=" col-md-3">Monthly <?php echo lang('salary'); ?></label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "salary",
            ...
            <div class="form-group">
                <label for="salary" class=" col-md-3">Monthly Working Hours</label>
                <div class=" col-md-9">
                    <?php
                    echo form_input(array(
                        "id" => "working_hours",
            ...
            <div class="form-group">
                <label for="salary" class=" col-md-3">Hourly Rate</label>
                <div class="col-md-9">
                    <strong><?php echo get_setting("currency_symbol"); ?> <span id="rate"></span></strong>
                </div>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.rate-cal').on('keyup', function () {
            var sal = parseFloat($('#salary').val());
            var monthHors = parseFloat($('#working_hours').val());
