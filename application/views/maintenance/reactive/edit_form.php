<div class="container">
 <form method="POST" action="<?php echo base_url('reactive/update_checklist') ?>" enctype="multipart/form-data">
     ...
     <div class="row">
      <div class="col-sm-4">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="job_type_name" value="<?php echo $jobs['job_type_id'];?>" disabled>
