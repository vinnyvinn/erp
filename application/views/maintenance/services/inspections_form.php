...
<link rel="stylesheet" href="<?php echo base_url();?>assets/js/datatable/css/dataTables.bootstrap.min.css">
  ...
  $(document).ready( function () {
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('inspection_types/inspections_add')?>";
      }
      else
      {
        url = "<?php echo site_url('inspection_types/inspections_update')?>";
      }
    ...
    function delete_inspection(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('inspection_types/inspections_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
