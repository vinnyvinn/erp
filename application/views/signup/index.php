            ...
            <div class="scrollable-page">
                <div class="signin-box">
                    <div class="panel panel-default clearfix">
                        ...
                        <img class="p20" src="<?php echo get_file_uri('files/system/default-stie-logo.png') ;?>">
                            <h2 class="form-signin-heading"><?php echo lang('signup'); ?></h2>
                            <p><?php echo $signup_message; ?></p>
                        </div>
                        <div class="panel-body"><?php echo form_open("signup/create_account", array("id" => "signup-form", "class" => "general-form", "role" => "form")); ?>
                        ...
                        <?php echo form_close(); ?>
                        <div id="signin_link" style="margin-bottom: 10px; text-align: center"><?php echo lang("already_have_an_account") . " " . anchor("signin", lang("signin")); ?></div>
                    </div>
                    
                    <div class="panel panel-default clearfix">
                        <div class="panel-heading text-center">
                        <a href="http://wizag.biz/" target="_blank"><img class="p20" src="<?php echo get_file_uri('files/system/wizag.png'); ?>"></a>
                        <p>© <?php echo date('Y'); ?></p>
                        </div>
                    </div>
