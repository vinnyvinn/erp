...
<div class="mb15 pr15 box">
    ...
    <div class="box-content form-group">
        <input type="hidden" name="comment_id" value="<?php echo isset($comment_id) ? $comment_id : 0; ?>">
    ...
    $(document).ready(function() {
        $(".reply-form").appForm({
            ...
            onSuccess: function(result) {
                ...
                var $triggerTarget = $("#reload-reply-list-button-" + "<?php echo isset($comment_id) ? $comment_id : 0; ?>");
