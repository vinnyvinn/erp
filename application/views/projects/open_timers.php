                        ...
                        <div  class="list-group-item"> 
                            <div class="clearfix">
                                ...
                                <span class="pull-right"><?php
                                    echo ajax_anchor(get_uri("projects/timer/" . $timer->project_id . "/stop"), "<i class='fa fa fa-clock-o'></i> " . lang('stop_timer'), array("class" => "btn btn-sm btn-danger", "title" => lang('stop_timer'), "data-reload-on-success" => "1"));
                                    ?>
                                </span>
                            </div>
