...
<ul class="nav nav-tabs vertical" role="tablist">
    ...
    <li role="presentation" class="<?php echo ($active_tab == 'technical') ? 'active' : ''; ?>"><a href="<?php echo_uri("technical"); ?>">Technical</a></li>
     <li role="presentation" class="<?php echo ($active_tab == 'projects') ? 'active' : ''; ?>"><a href="<?php echo_uri("sage_projects"); ?>">Projects</a></li>
     <li role="presentation" class="<?php echo ($active_tab == 'accounts') ? 'active' : ''; ?>"><a href="<?php echo_uri("gl_accounts"); ?>">GL Accounts</a></li>
