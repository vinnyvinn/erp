    ...
    <div class="panel panel-default">
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php
                if ($show_add_button) {
                    echo modal_anchor(get_uri("announcements/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_announcement'), array("class" => "btn btn-default", "data-modal-lg" => "1", "title" => lang('add_announcement')));
                };
                ?>
            </div>
        </div>
