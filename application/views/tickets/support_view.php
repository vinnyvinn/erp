            ...
            <div class="title-button-group p10">
                 ...
                 <span class="dropdown inline-block">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                        <li>
                            <?php   echo modal_anchor(get_uri("ticket_types/assign_modal"), "<i class='fa fa-stack-exchange'></i> Assign Ticket", array( "title" => "Assign Ticket", "data-post-view" => "details", "data-post-id" => $ticket_info['id']));
                              ?>
                        </li>
                        ...
                        <?php }?>
                            <li role="presentation">
                                ...
                                echo modal_anchor(get_uri("tickets/knowledge_base_modal_form"), "<i class='fa fa-stethoscope'></i> Add knowledge base", array( "title" => "Add knowledge base", "data-post-view" => "details", "data-post-id" => $ticket_info['id']));
                                 ...
                                 echo anchor(get_uri("tickets/ticket_solved_email"), "<i class='fa fa-stack-exchange'></i> Mark as Done", array( "title" => "Mark as Done", "data-post-view" => "details", "data-post-id" => $ticket_info['id']));
                                  ...
                                  echo anchor(get_uri("ticket_types/add_mark_solved"), "<i class='fa fa-stack-exchange'></i> Mark as Solved", array( "title" => "Mark as Solved", "data-post-view" => "details", "data-post-id" => $ticket_info['id']));
                            ...
                            <?php if ($ticket_info['status'] === "open" ) { ?>
                              <li role="presentation"><?php echo anchor(get_uri("ticket_types/add_mark_closed"), "<i class='fa fa-check-circle'></i> " . lang('mark_as_closed'), array("class" => "", "title" => 'Add Comment Before Closing', "data-reload-on-success" => "1")); ?> </li>
                          <?php }?>
