...
INSERT INTO `spares` (`id`, `stock_name`, `job_card_id`, `description`, `qnty_out`, `total`, `requisition_no`, `created`, `deleted`, `stock_id`, `warehouse_id`, `code_id`, `uom`, `category_id`, `stocking_id`, `avg_cost`, `qnty_in`) VALUES
...
INSERT INTO `trimmers` (`id`, `name`, `rate`, `created`, `updated`, `deleted`) VALUES
(1, 'Trimmer1', 50, '2018-04-25 23:46:55', NULL, 0),
(3, 'Trimmer2', 60, '2018-04-25 23:47:57', NULL, 0),
(4, 'Trimmer3', 80, '2018-04-25 23:48:11', NULL, 0);
...
--
-- Indexes for table `trimmers`
--
ALTER TABLE `trimmers`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `trimmer_sheets`
--
