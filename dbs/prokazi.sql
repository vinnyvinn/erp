...
--
-- Host: localhost
-- Generation Time: Jan 31, 2018 at 08:55 AM
...
(30, 'Infortex ict Solutions', 'ewwwgf', 'NYERI', 'Central', '00100', 'kenya', '2017-11-08', 'www.example.com', '0700000000', '', 0, '12143', '', 0);
...
(8, 'sasas', 'Insuarance', '2018-01-31', '2018-01-31', NULL, NULL, 5, 'N/A', '5', 0, '#d43480');
...
CREATE TABLE IF NOT EXISTS `petty_cash_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;
