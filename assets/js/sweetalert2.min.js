!function(e, t) {
    ...
    var e = "swal2-"
      ...
      , r = {
        ...
        confirmButtonColor: "#9ACA40",
        confirmButtonClass: null,
        cancelButtonText: "Cancel",
        cancelButtonColor: "#fd1046",
    ...
    l.length ? a = l[0] : (a = document.createElement("div"),
    ...
    var s = function(e, t) {
      ...
      , S = function(t) {
        var n = [w(), C()];
        return t && n.reverse(),
        n.concat(Array.prototype.slice.call(p().querySelectorAll("button:not([class^=" + e + "]), input:not([type=hidden]), textarea, select")))
    }
      , x = function(e, t) {
      ...
      , N = function() {
        ...
        c.previousActiveElement && c.previousActiveElement.focus && c.previousActiveElement.focus(),
    ...
    Object.assign || function(e) {
      ...
      , _ = function(e) {
        var t = p();
        for (var i in e)
            r.hasOwnProperty(i) || "extraParams" === i || console.warn('SweetAlert2: Unknown parameter "' + i + '"');
        ...
        e.text || e.html) {
            if ("object" === D(e.html))
                ...
                0 in e.html)
                    ...
                    l.appendChild(e.html.cloneNode(!0));
            else
                e.html ? l.innerHTML = e.html : e.text && (l.innerHTML = ("" + e.text).split("\n").join("<br>"));
            L(l)
        } else
            q(l);
        ...
        if (e.type) {
            ...
            if (!P)
                return console.error("SweetAlert2: Unknown alert type: " + e.type),
                !1;
        ...
        var O = h();
        e.imageUrl ? (O.setAttribute("src", e.imageUrl),
        L(O),
        ...
        O.className = n.image,
        e.imageClass && A(O, e.imageClass)) : q(O),
        ...
        e.buttonsStyling && (s.style.backgroundColor = e.confirmButtonColor,
        ...
        e.buttonsStyling ? (A(s, n.styled),
        A(c, n.styled)) : (B(s, n.styled),
        B(c, n.styled),
      ...
      , Q = function() {
        null === c.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (c.previousBodyPadding = document.body.style.paddingRight,
        document.body.style.paddingRight = j() + "px")
    }
      , Y = function() {
        null !== c.previousBodyPadding && (document.body.style.paddingRight = c.previousBodyPadding,
      ...
      , $ = function() {
        ...
        case "object":
            ...
            "email" === r.input && null === r.inputValidator && (r.inputValidator = function(e) {
            ...
            break;
        default:
            return console.error('SweetAlert2: Unexpected type of argument! Expected "string" or "object", got ' + D(t[0])),
            !1
        }
        _(r);
        var i = p();
        return new Promise(function(e, t) {
            ...
            for (var u = function(t) {
                ...
                r.preConfirm ? r.preConfirm(t, r.extraParams).then(function(n) {
                    F.closeModal(r.onClose),
                    e(n || t)
                }, function(e) {
                    F.hideLoading(),
                ...
                case "click":
                    c && F.isVisible() ? r.input ? !function() {
                        var e = l();
                        r.inputValidator ? (F.disableInput(),
                        r.inputValidator(e, r.extraParams).then(function() {
                            F.enableInput(),
                            u(e)
                        }, function(e) {
                            F.enableInput(),
                    ...
                    }() : u(!0) : d && F.isVisible() && (F.closeModal(r.onClose),
                    t("cancel"))
                }
            }, f = i.querySelectorAll("button"), m = 0; m < f.length; m++)
                f[m].onclick = d,
                f[m].onmouseover = d,
                f[m].onmouseout = d,
                f[m].onmousedown = d;
            ...
            a.onclick = function(e) {
                e.target === a && r.allowOutsideClick && (F.closeModal(r.onClose),
                t("overlay"))
            }
            ;
            var v = w()
            ...
            var x = function(e, t) {
              ...
              , M = function(e) {
                ...
                if ([9, 13, 32, 27].indexOf(o) !== -1) {
                    ...
                    9 === o ? (n.shiftKey ? x(l, -1) : x(l, 1),
                    n.stopPropagation(),
                    n.preventDefault()) : 13 === o || 32 === o ? l === -1 && (r.focusCancel ? H(h, n) : H(v, n)) : 27 === o && r.allowEscapeKey === !0 && (F.closeModal(r.onClose),
                    t("esc"))
                }
            };
            c.previousWindowKeyDown = window.onkeydown,
            window.onkeydown = M,
            r.buttonsStyling && (v.style.borderLeftColor = r.confirmButtonColor,
            ...
            F.hideLoading = F.disableLoading = function() {
                r.showConfirmButton || (q(v),
                r.showCancelButton || q(y())),
                B(v, n.loading),
                B(i, n.loading),
                v.disabled = !1,
                h.disabled = !1
            ...
            F.enableInput = function() {
                ...
                if (!e)
                    return !1;
                if ("radio" === e.type)
                    for (var t = e.parentNode.parentNode, n = t.querySelectorAll("input"), r = 0; r < n.length; r++)
                        n[r].disabled = !1;
                else
                    e.disabled = !1
            }
            ...
            "select" !== r.input && "radio" !== r.input || (r.inputOptions instanceof Promise ? (F.showLoading(),
            r.inputOptions.then(function(e) {
                F.hideLoading(),
                Y(e)
            })) : "object" === D(r.inputOptions) ? Y(r.inputOptions) : console.error("SweetAlert2: Unexpected type of inputOptions! Expected object or Promise, got " + D(r.inputOptions))),
            z(r.animation, r.onOpen),
            x(-1, 1),
            a.scrollTop = 0,
            "undefined" == typeof MutationObserver || R || (R = new MutationObserver(F.recalculateHeight),
            R.observe(i, {
                childList: !0,
                characterData: !0,
                subtree: !0
    ...
    F.queue = function(e) {
        ...
        return new Promise(function(e, r) {
            !function i(a, l) {
                a < K.length ? (t.setAttribute("data-queue-step", a),
                F(K[a]).then(function(e) {
                    o.push(e),
                    i(a + 1, l)
                }, function(e) {
                    n(),
    ...
    F.setDefaults = function(e) {
        ...
        for (var t in e)
            r.hasOwnProperty(t) || "extraParams" === t || (console.warn('SweetAlert2: Unknown parameter "' + t + '"'),
            delete e[t]);
        W(U, e)
    }
    ,
